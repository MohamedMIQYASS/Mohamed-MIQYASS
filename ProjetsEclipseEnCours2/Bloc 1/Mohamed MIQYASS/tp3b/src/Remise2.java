...
public class Remise2 {
	...
	public static void main(String[] args) {
		...
		float tauxRem1 = (5/100f);
		
		float tauxRem2 = (10/100f);
		...
		if (montAchete < 500) {
			...
			System.out.println("le montant acheté est " + montAchete);
			System.out.println("Aucune remise ne vous sera accordé ");
			
		}
		
		if (montAchete >= 500 && montAchete <= 1000 ) {
			
			System.out.println("Une remise de 5% vous est accordée ");
			
			// calcul du montant de la remise et du total à payer 

			montRem = montAchete * tauxRem1;
			totAPayer = montAchete - montRem;
			
			System.out.println("le montant achetée est " + montAchete);
			System.out.println("le montant de la remise est " + montRem);
			System.out.println("Le total à payer est " + totAPayer);
			
		}
		
		if (montAchete > 1000) {
			
			System.out.println("Une remise de 10% vous est accordée ");
			
			// calcul du montant de la remise et du total à payer 
			
			montRem = montAchete * tauxRem2;
			totAPayer = montAchete - montRem;
